...
<head>
    ...
    <title>Москва. Шкатулка с секретами</title>
...
<div class="about">
    ...
    <div class="about-body">
        <p>
            За три дня можно увидеть все основные достопримечательности нашей столицы, побывать на Красной площади,
            сфотографироваться на парящем мосту в Зарядье, узнать историю в захватывающем квесте по Измайловскому кремлю.
            Лабиринт истории в Музее кино – проводник в волшебный мир мультипликации и кинематографии. Контраст старинных
            особняков, сталинских высоток, башен Москва-Сити. Посещение главного зоопарка России.
        </p>
    </div>
</div>
<section class="program">
    ...
    <div class="program-day">
        <div class="day-title" onclick="openOrClose(document.getElementById('day-one'))">
            ...
            <h4>
                Автобусная экскурсия «Разнообразие столицы» -
                ВДНХ - Архитектурный макет Москвы - Музей Кино
            </h4>
        </div>
        <div id="day-one" class="day-body">
            ...
            <div class="day-body-text">
                ...
                <p>
                    ...
                    и архитектурными ансамблями территория. З
                    десь соседствуют Ростокинский акведук XVIII века и современная монорельсовая дорога,
                    дворец Шереметьева и Останкинская Телебашня, монумент «Рабочий и колхозница» и гостиница Космос
                </p>
                <p>
                    Прогулка по Выставке достижений народного хозяйства – один из крупнейших выставочных центров мира,
                    территория которого богата архитектурными памятниками советской эпохи. К числу наиболее ярких относятся
                    символ Мосфильма «Рабочий и колхозница», фонтаны «Дружба народов» и «Каменный цветок», уникальные павильоны

                </p>
                <p>
                    Посещение Павильона Архитектурный макет Москвы
                    На площади 369 квадратных метров в масштабе 1:400 представлена центральная часть города, как на ладони
                    виден весь исторический центр: Московский Кремль и Красная площадь, храм Христа Спасителя и Дом на набережной.
                    Главная отличительная особенность макета столицы — поразительная детализация зданий и максимально
                    точное воссоздание ландшафтного рельефа
                </p>
                <p>
                    <strong>
                        Обед<br>
                ...
                <p>
                    <strong>
                        Экскурсия «Лабиринт истории» в Музее Кино
                    </strong>
                    <br>
                    В музее с помощью уникальных экспозиций и волшебного мира кино можно окунуться в разные исторические
                    эпохи, побывать в разных странах, перелистать страницы литературных произведений. Одна из экспозиций музея
                    – «Лабиринт истории» рассказывает о главных этапах российского кинематографа
                </p>
                <p>
            ...
            <div class="day-body-gallery">
                ...
                <div class="mySlides">
                    ...
                    <img src="../../images/open-tour/tour-2/day-1/a1.jpg" style="width:100%">
                </div>
                <div class="mySlides">
                    <div class="numbertext">2 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-1/a2.jpeg" style="width:100%">
                </div>
                <div class="mySlides">
                    <div class="numbertext">3 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-1/a3.jpg" style="width:100%">
                </div>
                <div class="mySlides">
                    <div class="numbertext">4 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-1/a4.jpg" style="width:100%">
                </div>
                <div class="mySlides">
                    <div class="numbertext">5 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-1/a5.jpg" style="width:100%">
                </div>
                <div class="mySlides">
                    <div class="numbertext">6 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-1/a6.jpg" style="width:100%">
                </div>
                ...
                <div class="row">
                    <div class="column">
                        <img class="demo cursor" src="../../images/open-tour/tour-2/day-1/a1.jpg" style="width:100%" onclick="currentSlide(1)" alt="The Woods">
                    </div>
                    <div class="column">
                        <img class="demo cursor" src="../../images/open-tour/tour-2/day-1/a2.jpeg" style="width:100%" onclick="currentSlide(2)" alt="Cinque Terre">
                    </div>
                    <div class="column">
                        <img class="demo cursor" src="../../images/open-tour/tour-2/day-1/a3.jpg" style="width:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
                    </div>
                    <div class="column">
                        <img class="demo cursor" src="../../images/open-tour/tour-2/day-1/a4.jpg" style="width:100%" onclick="currentSlide(4)" alt="Northern Lights">
                    </div>
                    <div class="column">
                        <img class="demo cursor" src="../../images/open-tour/tour-2/day-1/a5.jpg" style="width:100%" onclick="currentSlide(5)" alt="Nature and sunrise">
                    </div>
                    <div class="column">
                        <img class="demo cursor" src="../../images/open-tour/tour-2/day-1/a6.jpg" style="width:100%" onclick="currentSlide(6)" alt="Snowy Mountains">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="program-day">
        <div class="day-title" onclick="openOrClose(document.getElementById('day-two'))">
            ...
            <h4>
                Пешеходная экскурсия «Сердце Родины» - Зарядье - Измайловский Кремль
            </h4>
        </div>
        <div id="day-two" class="day-body">
            ...
            <div class="day-body-text">
                ...
                <p>
                    <strong>Пешеходная Обзорная экскурсия «Сердце Родины»</strong>
                    <br>
                ...
                <p>
                    <strong>Интерактивная экскурсия по Измайловскому Кремлю «Ремесленная слобода»
                    </strong>
                    <br>
                    Прогулка по кремлю – словно экскурс в историческое прошлое России и Москвы: завораживающие своим величием
                    сооружения, в точности повторяющие архитектуру зданий времен допетровской эпохи, шумные и яркие торговые
                    ярмарочные ряды Вернисажа, мастерские современных народных ремесленников «Русского подворья», целая галерея
                    музеев, экспонаты которых восхищают и удивляют

                </p>
                <p>
                    <strong>
                    16:00 ТВозвращение в отель<br>
                    Ночь в отеле
                    </strong>
                </p>
            </div>
            <div class="day-body-gallery">
                ...
                <div class="mySlides-two">
                    <div class="numbertext">1 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-2/t1.jpg" style="width:100%">
                </div>
                <div class="mySlides-two">
                    <div class="numbertext">2 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-2/t2.jpg" style="width:100%">
                </div>
                <div class="mySlides-two">
                    <div class="numbertext">3 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-2/t3.jpg" style="width:100%">
                </div>
                <div class="mySlides-two">
                    <div class="numbertext">4 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-2/t4.jpg" style="width:100%">
                </div>
                <!-- Next and previous buttons -->
                ...
                <div class="row">
                    <div class="column">
                        <img class="demo-two cursor" src="../../images/open-tour/tour-2/day-2/t1.jpg" style="width:100%" onclick="currentSlider(1)" alt="The Woods">
                    </div>
                    <div class="column">
                        <img class="demo-two cursor" src="../../images/open-tour/tour-2/day-2/t2.jpg" style="width:100%" onclick="currentSlider(2)" alt="Cinque Terre">
                    </div>
                    <div class="column">
                        <img class="demo-two cursor" src="../../images/open-tour/tour-2/day-2/t3.jpg" style="width:100%" onclick="currentSlider(3)" alt="Mountains and fjords">
                    </div>
                    <div class="column">
                        <img class="demo-two cursor" src="../../images/open-tour/tour-2/day-2/t4.jpg" style="width:100%" onclick="currentSlider(4)" alt="Northern Lights">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="program-day">
        <div class="day-title"
            ...
            <h4>
                Автобусная экскурсия «Лик современного города» - Московский зоопарк            </h4>
        </div>
        <div id="day-five" class="day-body">
            ...
            <div class="day-body-text">
                ...
                <p>
                    <strong>
                        Автобусная обзорная экскурсия «Лик современного города»
                    </strong>
                    <br>
                    Москва воплотила в себе лучшее черты мировых столиц, ее облик вполне гармонично сочетает историю и
                    современность. Мы проедем по главным московским площадям, полюбуемся московскими высотками, побываем
                    на смотровой площадке Воробьевых гор у стен МГУ, увидим современный хром Лужников и старинный белый
                    камень Новодевичьего монастыря, величественную громаду Москва-Сити, причудливость Моста Багратион и т
                    оржественность Поклонной горы
                </p>
                <p>
                <p>
                    <strong>
                ...
                <p>
                    — Катание на современной Канатной дороге «Лужники-Воробьевы»
                    Знакомство с Москвой с видом на Воробьевы Горы, знаменитый спорткомплекс «Лужники», МГУ им. М.В.
                    Ломоносова, панораму города с комплексом башен Москва Сити
                ...
                <p>
                    ...
                    <br>
                    Московский зоопарк— зоологический парк в центре Москвы, один из старейших зоопарков в Европе и
                    четвёртый по площади зоопарк России. Он входит в десятку самых посещаемых зоопарков мира и обладает
                    огромной коллекцией животных
                </p>
                <p>
                    <strong>
            ...
            <div class="day-body-gallery">
                ...
                <div class="mySlides-five">
                    <div class="numbertext">1 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-3/r1.jpg" style="width:100%">
                </div>
                <div class="mySlides-five">
                    <div class="numbertext">2 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-3/r2.jpg" style="width:100%">
                </div>
                <div class="mySlides-five">
                    <div class="numbertext">3 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-3/r3.jpg" style="width:100%">
                </div>
                <div class="mySlides-five">
                    <div class="numbertext">4 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-3/r4.jpg" style="width:100%">
                </div>
                <div class="mySlides-five">
                    <div class="numbertext">5 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-3/r5.jpg" style="width:100%">
                </div>
                <div class="mySlides-five">
                    <div class="numbertext">6 / 6</div>
                    <img src="../../images/open-tour/tour-2/day-3/r6.jpg" style="width:100%">
                </div>
                <!-- Next and previous buttons -->
                ...
                <div class="row">
                    <div class="column">
                        <img class="demo-five cursor" src="../../images/open-tour/tour-2/day-3/r1.jpg" style="width:100%" onclick="currentSliderFive(1)" alt="The Woods">
                    </div>
                    <div class="column">
                        <img class="demo-five cursor" src="../../images/open-tour/tour-2/day-3/r2.jpg" style="width:100%" onclick="currentSliderFive(2)" alt="Cinque Terre">
                    </div>
                    <div class="column">
                        <img class="demo-five cursor" src="../../images/open-tour/tour-2/day-3/r3.jpg" style="width:100%" onclick="currentSliderFive(3)" alt="Mountains and fjords">
                    </div>
                    <div class="column">
                        <img class="demo-five cursor" src="../../images/open-tour/tour-2/day-3/r4.jpg" style="width:100%" onclick="currentSliderFive(4)" alt="Northern Lights">
                    </div>
                    <div class="column">
                        <img class="demo-five cursor" src="../../images/open-tour/tour-2/day-3/r5.jpg" style="width:100%" onclick="currentSliderFive(5)" alt="Nature and sunrise">
                    </div>
                    <div class="column">
                        <img class="demo-five cursor" src="../../images/open-tour/tour-2/day-3/r6.jpg" style="width:100%" onclick="currentSliderFive(6)" alt="Snowy Mountains">
                    </div>
                </div>
            </div>
        </div>
    ...
    <form action="../../functions/excursion.php" method="post" class="form-main">
        ...
        <div class="form-price">
            <div class="line-adult lines">
                ...
                <div class="lines-price">8100 ₽</div>
            ...
            <div class="line-not-adult lines">
                ...
                <div class="lines-price">6750 ₽</div>
                <div class="lines-select">
